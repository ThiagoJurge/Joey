...
"""Classe para verificar qual o ASN que está anunciando e qual a preferencia dele, em qual upstream"""
class RipeQuery:
    def __init__(self):
    ...
    def verify_asn(self, asn):
        ...
        if response.status_code == 200:
            ...
            # Em caso de erro, você pode lançar uma exceção ou retornar uma mensagem de erro
